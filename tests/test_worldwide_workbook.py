...
def test_worldwide_workbook_groups_cross_source_duplicates(tmp_path: Path) -> None:
    ...
    jobs = [
        JobRecord(
            ...
            normalized_role="Senior E3D Piping Designer",
            company="Global EPC",
            location="Abu Dhabi, UAE",
            city="Abu Dhabi",
            country="United Arab Emirates",
            description="Official employer vacancy with AVEVA E3D layout duties.",
        ...
        JobRecord(
            ...
            city="Abu Dhabi",
            country="United Arab Emirates",
            description="Recruiter summary for the same vacancy and location.",
    ...
    assert row[headers["duplicate_status"] - 1].value == "cross_source_duplicate"
