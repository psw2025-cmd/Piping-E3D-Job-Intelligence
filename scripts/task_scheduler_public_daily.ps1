...
$action = New-ScheduledTaskAction -Execute $pwsh -Argument "-NoProfile -NonInteractive -ExecutionPolicy Bypass -File $quotedWrapper -RepoRoot $quotedRepo -DataRoot $quotedData" -WorkingDirectory $RepoRoot
